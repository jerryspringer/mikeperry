...
# I thought by introducing the idea of defusing a bomb, it would be more interesting than making it into a board game.
# though the plot isn't captivating, it makes sense in this context
